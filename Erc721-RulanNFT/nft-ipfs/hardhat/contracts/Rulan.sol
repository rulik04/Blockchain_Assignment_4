...
contract Rulan is ERC721Enumerable, Ownable {
    ...
    /**
        ...
        * name in our case is `Rulan` and symbol is `LW3P`.
        * Constructor for LW3P takes in the baseURI to set _baseTokenURI for the collection.
        */
    constructor (string memory baseURI) ERC721("Rulan", "RLN3") {
    ...
    */
    function mint() public payable onlyWhenNotPaused {
        require(tokenIds < maxTokenIds, "Exceed maximum Rulan supply");
